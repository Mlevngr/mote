...
**[直接下载 Mote 0.8.0 APK（插件平台与主页侧边栏）](https://github.com/Mlevngr/note/releases/download/v0.8.0-r10/Mote-0.8.0-r10.apk?download=1)**

**[可选：下载 Mote AI Organizer 插件 APK](https://github.com/Mlevngr/note/releases/download/v0.8.0-r10/Mote-AI-Organizer-1.0.0.apk?download=1)**
