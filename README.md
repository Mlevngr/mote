...
**[直接下载 Mote 0.7.8 APK](https://github.com/Mlevngr/note/releases/download/v0.7.8/Mote-0.7.8.apk)**
...
- 在当前行按回车会拆分并进入下一行；有序列表会自动续写下一编号。在连续同级编号项之间插入新行，或对中间正文应用“有序列表”时，会按上下文重排整段编号，同时保留有意设置的起始编号和不同缩进层级。
