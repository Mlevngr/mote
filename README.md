...
**[直接下载 InkNote 0.7.1 APK](https://github.com/Mlevngr/note/releases/download/v0.7.1/InkNote-0.7.1.apk)**
...
- 笔记缩略图优先显示正文中的第一张内部图片；没有图片时显示笔记图标，并使用 Markdown 正文生成短摘要。预览读取和图片解码均不阻塞目录界面。
- 如需更紧凑的目录，可选择“仅显示标题”，隐藏图片与正文摘要。
- 文件夹菜单提供蓝、紫、粉、橙、绿、灰六种颜色标记；颜色元数据会随文件夹重命名和移动一起保留。
