...
**[直接下载 InkNote 0.7.3 APK](https://github.com/Mlevngr/note/releases/download/v0.7.3/InkNote-0.7.3.apk)**
...
- 文件夹菜单提供蓝、紫、粉、橙、绿、灰六种纯色预览色块，不再显示冗余颜色文字；颜色元数据会随文件夹重命名、移动、回收和恢复一起保留。
